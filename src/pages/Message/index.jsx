...
import { Icon, NavBar, InputItem, Grid, List, Badge, SwipeAction, Popover } from 'antd-mobile';
...
class Message extends React.Component {
  ...
  render(){
    ...
    _.forEach(_.get(contacts, "friends", []), (name, index) => {
      ...
      const contactInLele = myContacts.myContacts.find(c => c.imusername === name) || {};
      items[index] = {
          name,
          unread: count,
      ...
      <NavBar
        ...
        rightContent={[
          <Popover
            ...
            overlay={[
              (<Popover.Item key="1" icon={<img src={myImg('qunliao')} alt="" />} >发起群聊</Popover.Item>),
              (<Popover.Item key="2" icon={<img src={myImg('add_friend')} alt="" />} style={{ whiteSpace: 'nowrap' }}>添加朋友</Popover.Item>),
            ]}
            align={{
      ...
      <List className="my-list">
          ...
          </Item>
        {
          items.map((d, index) => <Item
            ...
            extra={d.latestTime} 
            align="top" 
            thumb={d.icon || 'http://happyeveryone.oss-cn-shanghai.aliyuncs.com/35_3e4f3b77e4b3458eb1efd5b53b74695b.png'} 
            multipleLine>
            {d.nickname}
